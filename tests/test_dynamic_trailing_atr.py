...
class TestDynamicTrailingATR(unittest.TestCase):
    ...
    def test_dynamic_atr_with_sufficient_samples(self):
        ...
        initial_atr = self.strategy.update_atr(high=103.0, low=101.0, prev_close=102.0)  # TR = 2.0
        # ATR = 2.0
        ...
        new_atr = self.strategy.update_atr(high=104.0, low=103.0, prev_close=103.5)  # TR = 1.0
        ...
        self.assertAlmostEqual(distance, expected_dynamic_atr, places=1, 
                             msg="Should use dynamic ATR when enough samples available")
        self.assertNotEqual(distance, entry_atr, "Should not use entry ATR when dynamic is available")
    ...
    def test_fallback_to_entry_atr_insufficient_samples(self):
        ...
        self.assertEqual(distance, entry_atr, 
    ...
    def test_dynamic_atr_trailing_stop_update(self):
        ...
        self.assertEqual(stop_price, expected_stop, "Initial trailing stop should use ATR of 2.0")
    ...
    def test_static_atr_vs_dynamic_atr_behavior(self):
        ...
        self.assertAlmostEqual(dynamic_distance, 5.0/3.0, places=2, 
                             msg="Dynamic strategy should use updated ATR")
        self.assertNotEqual(static_distance, dynamic_distance, 
