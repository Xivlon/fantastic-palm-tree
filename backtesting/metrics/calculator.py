...
class MetricsCalculator:
    ...
    @staticmethod
    def calculate(results: BacktestResults, 
        ...
        cumulative_return = equity_curve['equity'].iloc[-1] / results.portfolio.initial_cash - 1
        ...
        # Drawdown metrics
        max_drawdown, max_dd_duration = MetricsCalculator._calculate_drawdown_metrics(equity_curve['equity'])
        ...
        if benchmark is not None:
            beta, alpha, information_ratio, tracking_error = MetricsCalculator._calculate_benchmark_metrics(
    ...
    @staticmethod
    def _calculate_benchmark_metrics(returns: pd.Series, benchmark: pd.Series, 
                                   risk_free_rate: float) -> Tuple[float, float, float, float]:
