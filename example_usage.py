...
from backtesting import (
    BacktestEngine, Strategy, MetricsCalculator, 
    ParameterSpace, GridSearchOptimizer, create_default_kill_switches
)
...
class MovingAverageCrossoverStrategy(Strategy):
    ...
    def on_data(self, timestamp, data):
        ...
        if self.data_handler:
            hist_data = self.data_handler.get_historical_data(symbol, 
                                                             max(self.short_window, self.long_window) + 5)
